...
export default function AnimatedShaderBackground() {
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          for (float i = 0.0; i < 35.0; i++) {
            ...
            v += vec2(sin(iTime * 3.0 + i) * 0.003, cos(iTime * 3.5 - i) * 0.003);
            ...
            currentContribution /= length(max(v, vec2(v.x * f * 0.015, v.y * 1.5)));
  ...
  return <div ref={containerRef} className="contact-shader-canvas" aria-hidden="true" />;
}
